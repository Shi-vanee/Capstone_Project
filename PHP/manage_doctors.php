                        ...
                        <div class="well">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $doctors = $conn->query("SELECT * FROM doctors ORDER BY DoctorID DESC");
                                        while ($doctor = $doctors->fetch_assoc()) {
                                            echo "<tr>
                                                ...
                                                <td>
                                                    <a href='edits_doctor.php?id={$doctor['DoctorID']}' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i> Edit</a>
                                                    <a href='delete_doctor.php?id={$doctor['DoctorID']}' class='btn btn-danger btn-xs' onclick='return confirm(\"Are you sure you want to delete this doctor?\")'><i class='fa fa-trash'></i> Delete</a>
                                                </td>
                                            </tr>";
                                        }
                                        ?>
